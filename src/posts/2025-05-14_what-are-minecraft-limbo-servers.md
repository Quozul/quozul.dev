...
|------|----------|----------|------------|--------|
| [**PicoLimbo**](https://github.com/Quozul/PicoLimbo) | Rust | Standalone | 1.7.2–26.2 | ✅ Active |
| [**LOOHP/Limbo**](https://github.com/LOOHP/Limbo) | Java | Standalone | 26.2 | ✅ Active |
| [**NanoLimbo**](https://github.com/BoomEaro/NanoLimbo) | Java | Standalone | 1.7.2–26.2 | 🌀 Forks only |
...
*As of writing, Minecraft 26.2 is the latest release. Servers that support the two last protocol versions of Minecraft are considered actively maintained unless otherwise noted.*
