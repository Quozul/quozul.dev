...
class Token
{
    ...
    function create($headers, $payload): string
    {
        ...
        //build the signature
        $this->signature = hash_hmac('sha256', "$this->headers_encoded.$this->payload_encoded", getenv("JWT_SECRET"), true);
    ...
    function validate(): bool
    {
        ...
        $signature = hash_hmac('sha256', $this->headers_encoded . "." . $this->payload_encoded, getenv("JWT_SECRET"), true);
